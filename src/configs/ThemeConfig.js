...
const getBaseComponentThemeConfig = (
    ...
    return {
        ...
        Menu: {
            ...
            activeBarWidth: 3,
            itemSelectedColorHorizontal: baseTheme.colorPrimary,
            itemHoverColor: baseTheme.colorPrimary,
            itemSelectedColor: baseTheme.colorPrimary,
            itemBgSelected: rgba(baseTheme.colorPrimary, 0.1),
            itemBgHover: 'transparent',
            radiusItem: 0,
...
export const darkTheme = {
    ...
    components: getBaseComponentThemeConfig({
        ...
        Menu: {
            itemBgSelected: 'transparent',
            itemSelectedColorHorizontal: GRAY_SCALE.WHITE,
